...
async def test_hub_get_smoke_status_detected():
    ...
    state = await hive_session.hub.getSmokeStatus(smoke_sensor)
...
async def test_hub_get_glass_break_detected():
    ...
    state = await hive_session.hub.getGlassBreakStatus(glass_sensor)
...
async def test_hub_get_dog_bark_detected():
    ...
    state = await hive_session.hub.getDogBarkStatus(dog_sensor)
